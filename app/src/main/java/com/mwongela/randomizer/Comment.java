...
public class Comment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       userImage=findViewById(R.id.commentingUserImage);
      ...
      //  mDatabase = FirebaseDatabase.getInstance().getReference().child("Posts");
        ...
        if (currentUser == null) {
            ...
            Intent loginIntent = new Intent(Comment.this, RegisterActivity.class);
        ...
        postComment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Lis
                Toast.makeText(Comment.this, "POSTING...", Toast.LENGTH_LONG).show();
    ...
    private void updateUI(final FirebaseUser currentUser) {
        ...
        adapter = new FirebaseRecyclerAdapter<CommentModel, Comment.commentModelViewHolder>(options) {
            ...
            @NonNull
            @Override
            public Comment.commentModelViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                //inflate the layout where you have the card view items
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.comment_item, parent, false);
                return new Comment.commentModelViewHolder(view);
            }
