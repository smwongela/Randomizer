        ...
        doneBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(name) && profileImageUri != null) {
                    ...
                    Toast.makeText(ProfileActivity.this, "Uploading", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(ProfileActivity.this, "Click the + button to add your profile photo", Toast.LENGTH_SHORT).show();
